...
object. It is not refused either - a round-2 review proposed refusing it and that was rejected as outside the
story's acceptance criteria (D10 in the package spec). "Empty filter" is therefore an ambiguous phrase and
