...
|---|---|---|
| `CreateBusinessProcessOptions` (CreateBusinessProcessCommand.cs) | `1.6.6.11` | yes |
| `ModifyBusinessProcessOptions` (ModifyBusinessProcessCommand.cs) | `1.6.6.11` | yes |
| `ModifyProcessAsNewVersionOptions` (ModifyProcessAsNewVersionCommand.cs) | `1.6.6.11` | yes |
