...
|---|---|---|
| `CreateBusinessProcessOptions` (CreateBusinessProcessCommand.cs) | `1.6.6.12` | yes |
| `ModifyBusinessProcessOptions` (ModifyBusinessProcessCommand.cs) | `1.6.6.12` | yes |
| `ModifyProcessAsNewVersionOptions` (ModifyProcessAsNewVersionCommand.cs) | `1.6.6.12` | yes |
