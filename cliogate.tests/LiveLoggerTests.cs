...
public class LiveLoggerTests
{
    ...
    public void Log_InfoMessage_UsesLogInfo()
    {
        ...
        // Assert
        _mockWebSocket.Received(1).PostMessageToAll("Clio", "Show logs",
            "<span style='color:green'>[INF]</span> - This is an info message");
    }
    ...
    public void Log_ErrorMessage_UsesLogError()
    {
        ...
        // Assert
        _mockWebSocket.Received(1).PostMessageToAll("Clio", "Show logs",
            "<span style='color:red'>[ERR]</span> - This is an error message");
    }
    ...
    public void Log_WarnMessage_UsesLogWarn()
    {
        ...
        // Assert
        _mockWebSocket.Received(1).PostMessageToAll("Clio", "Show logs",
            "<span style='color:yellow'>[WAR]</span> - This is a warning message");
    }
