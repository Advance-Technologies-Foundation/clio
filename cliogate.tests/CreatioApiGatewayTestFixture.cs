...
public class CreatioApiGatewayTestFixture : BaseMarketplaceTestFixture
{
    ...
    private void MockSysSettingsEntity(string code, string valueTypeName)
    {
        ...
        MockEntitySchemaWithColumns(schemaName,
            new Dictionary<string, DataValueType>
            {
                { "Code", DataValueType.Text }, { "ValueTypeName", DataValueType.Text }
            });

        SetUpTestData(schemaName,
            new Dictionary<string, object> { { "Code", code }, { "ValueTypeName", valueTypeName } });
    }
    ...
    private void MockSysSetting(string code, object value)
    {
        ...
        FakeSysSettings settings = new() { Code = code };
    ...
    {
        new("DateTime", "dd-MMM-yyyy HH:mm:ss"), new("Date", "dd-MMM-yyyy"), new("Time", "HH:mm:ss")
    };
}

public class TestDataItem(string valueTypeName, string formatString)
{
