...
public class SQLFunctionsTests : BaseMarketplaceTestFixture
{
    ...
    public void Script_Returns_RowsInJson()
    {
        ...
        PropertyInfo propertyInfo =
            gasType.GetProperty("DenyCustomQueryApiUsage", BindingFlags.Static | BindingFlags.NonPublic);
        ...
        //Act
        string actual = SQLFunctions.ExecuteSQL(sqlString, UserConnection);
        List<Dto>? list = JsonConvert.DeserializeObject<List<Dto>>(actual);
    ...
    public bool sqlEval(string sqlString) => true;
}
