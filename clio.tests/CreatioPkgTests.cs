...
public class CreatioPkgTests
{
    ...
    [TestCase(CreatioPackage.DescriptorName, CreatioPackage.DescriptorName, "CreateDescriptor",
        TestName = "Check Correct Descriptor")]
    ...
    public void CreatioPkg_Create_CheckPackageStructure()
    {
        ...
        CreatioPackage pkg = CreatioPackage.CreatePackage(PackageName, Maintainer);
    ...
    public void CreatioPkg_Create_CheckCorrectTplFilePathGettingFromPath()
    {
        ...
        string resultPath = Path.Combine(pkg.FullPath, CreatioPackage.PackageConfigName);
        string samplePath =
            Path.Combine(Environment.CurrentDirectory, ExpectFilesDir, CreatioPackage.PackageConfigName);
        File(resultPath).Should().Exist();
        File.ReadAllText(resultPath).Should().BeEquivalentTo(File.ReadAllText(samplePath));
    }
