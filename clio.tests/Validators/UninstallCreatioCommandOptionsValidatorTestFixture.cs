    ...
    public static IEnumerable<TestCaseData> EnvironmentNameIsEmptyTestCases
    {
        get
        {
            yield return new TestCaseData(new Tuple<UninstallCreatioCommandOptions, ValidationFailure>(
                ...
                .SetDescription(
                    "Tests that the validator returns an error when both the EnvironmentName and PhysicalPath is empty.");

            yield return new TestCaseData(new Tuple<UninstallCreatioCommandOptions, ValidationFailure>(
                    new UninstallCreatioCommandOptions { PhysicalPath = string.Empty },
                    new ValidationFailure
                    {
                        ErrorCode = "ArgumentParse.Error",
                        ErrorMessage = "Either path to creatio directory or environment name must be provided",
            ...
            yield return new TestCaseData(new Tuple<UninstallCreatioCommandOptions, ValidationFailure>(
                    new UninstallCreatioCommandOptions { EnvironmentName = string.Empty },
                    new ValidationFailure
                    {
                        ErrorCode = "ArgumentParse.Error",
                        ErrorMessage = "Either path to creatio directory or environment name must be provided",
            ...
            yield return new TestCaseData(new Tuple<UninstallCreatioCommandOptions, ValidationFailure>(
                    new UninstallCreatioCommandOptions { EnvironmentName = "env1", PhysicalPath = @"some value" },
                    new ValidationFailure
                    {
                        ErrorCode = "ArgumentParse.Error",
                        ErrorMessage =
            ...
            yield return new TestCaseData(new Tuple<UninstallCreatioCommandOptions, ValidationFailure>(
                    new UninstallCreatioCommandOptions { PhysicalPath = @"some value" },
                    new ValidationFailure
                    {
                        ErrorCode = "ArgumentParse.Error",
            ...
            yield return new TestCaseData(new Tuple<UninstallCreatioCommandOptions, ValidationFailure>(
                    new UninstallCreatioCommandOptions { PhysicalPath = @"https://google.ca" },
                    new ValidationFailure
                    {
                        ErrorCode = "ArgumentParse.Error",
                        ErrorMessage = "PhysicalPath must be a valid directory path",
            ...
            yield return new TestCaseData(new Tuple<UninstallCreatioCommandOptions, ValidationFailure>(
                    new UninstallCreatioCommandOptions { PhysicalPath = @"C:\inetpub\" },
                    new ValidationFailure
                    {
                        ErrorCode = "ArgumentParse.Error",
