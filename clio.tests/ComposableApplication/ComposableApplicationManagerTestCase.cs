...
{
    private const string IconPath = @"T:\SVG_Icons\Partner.svg";
...
public class ZipFileMockWrapper(MockFileSystem fileSystem, IWorkingDirectoriesProvider workingDirectoriesProvider): IZipFile
{
