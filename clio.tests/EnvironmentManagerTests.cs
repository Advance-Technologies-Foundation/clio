...
internal class EnvironmentManagerTest : BaseClioModuleTests
{
    ...
    public void GetEnvironmentPackagesManifest()
    {
        ...
        [
            new()
            {
                Name = "Base", Hash = "1234567890"
            },
            new()
            {
                Name = "UI", Hash = "0987654321"
            }
        ];
    ...
    public void GetSettingsFromManifest(string manifestFileName, int count)
    {
        ...
        [
            new()
            {
                Code = "IntSysSettingsATF", Value = "10"
            },
            new()
            {
                Code = "FloatSysSettingsATF", Value = "0.5"
            },

            new()
            {
                Code = "StringSettingsATF", Value = "ATF"
            },

            new()
            {
                Code = "DateTimeSettingsATF", Value = "2021-01-01T00:00:00"
            },

            new()
            {
                Code = "GuidSettingsATF", Value = "00000000-0000-0000-0000-000000000001"
            },

            new()
            {
                Code = "LookupSettingsATF", Value = "TextLookupValue"
            },
            new()
            {
    ...
    public void GetWebServicesFromManifest(string manifestFileName, int count)
    {
        ...
        [
            new()
            {
                Name = "WebService1", Url = "https://preprod.creatio.com/0/ServiceModel/EntityDataService.svc"
            },
            new()
            {
                Name = "WebService2", Url = "https://preprod.creatio.com/0/ServiceModel/EntityDataService.svc"
            }
        ];
    ...
    public void SaveEnvironmentPackagesInReversOrderManifest()
    {
        ...
        EnvironmentManifest environmentManifest = new()
        {
            ...
            {
                Uri = environmentUrl, AuthAppUri = null
            },
