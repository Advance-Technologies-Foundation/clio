...
public class BundledProcessBuilderPackageTests {
	...
	/// 156 byte-identical, the 157th being the restamped <c>descriptor.json</c>) was NOT re-run for the 1.6.6.11 cut.
	...
	private const string ExpectedArchiveSha256 =
		"8DACEB2B8F7C4D545D3C03994F00EB760C4AC0F7AF1D9667D220F51CFF5BCC42";
	...
	/// </para>
	/// </remarks>
	private const string ExpectedArchiveVersion = "1.6.6.11";
	...
	/// </summary>
	private const string ExpectedProducingCommit = "8be2929a8d28d9570b29cd3a6299d17796492609";
	...
	/// </para>
	/// </remarks>
	private const string ExpectedDescriptorModifiedOnUtc = "/Date(1790096898000)/";
	...
	public void BundledArchive_ShouldCarryAtLeastEveryDeclaredRequirement() {
		...
		// each other — create, modify and modify-as-new-version at 1.6.6.11 since ENG-99856 (create and modify had
