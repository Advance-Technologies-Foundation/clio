...
internal class ServiceUrlBuilderCommandTests
{
    ...
    public static IEnumerable<TestCaseDataWithEnvSetting> TestCasesWithEnvSettings
    {
        get
        {
            yield return new TestCaseDataWithEnvSetting("somepath1",
                ...
                {
                    IsNetCore = false, Uri = "http://localhost"
                }, "http://localhost/0/somepath1");
            yield return new TestCaseDataWithEnvSetting("somepath1",
                new EnvironmentSettings
                {
                    IsNetCore = true, Uri = "http://localhost"
                }, "http://localhost/somepath1");
            ...
            yield return new TestCaseDataWithEnvSetting("somepath1",
                new EnvironmentSettings
                {
                    IsNetCore = false, Uri = "http://localhost:81/"
                },
                "http://localhost:81/0/somepath1");
            yield return new TestCaseDataWithEnvSetting("somepath1",
                new EnvironmentSettings
                {
                    IsNetCore = true, Uri = "http://localhost:81/"
                },
            ...
            yield return new TestCaseDataWithEnvSetting("somepath1",
                new EnvironmentSettings
                {
                    IsNetCore = false, Uri = "http://localhost:81/sub"
                },
                "http://localhost:81/sub/0/somepath1");
            yield return new TestCaseDataWithEnvSetting("somepath1",
                new EnvironmentSettings
                {
                    IsNetCore = true, Uri = "http://localhost:81/sub"
                },
                "http://localhost:81/sub/somepath1");
            ...
            yield return new TestCaseDataWithEnvSetting("somepath1",
                new EnvironmentSettings
                {
                    IsNetCore = false, Uri = "https://localhost"
                },
                "https://localhost/0/somepath1");
            yield return new TestCaseDataWithEnvSetting("somepath1",
                new EnvironmentSettings
                {
                    IsNetCore = true, Uri = "https://localhost"
                }, "https://localhost/somepath1");
            ...
            yield return new TestCaseDataWithEnvSetting("somepath1",
                new EnvironmentSettings
                {
                    IsNetCore = false, Uri = "https://localhost:81/"
                },
                "https://localhost:81/0/somepath1");
            yield return new TestCaseDataWithEnvSetting("somepath1",
                new EnvironmentSettings
                {
                    IsNetCore = true, Uri = "https://localhost:81/"
                },
    ...
    public void Build_Returns_CorrectUrl(TestCaseData testCaseData)
    {
        ...
        {
            Uri = testCaseData.Uri, IsNetCore = testCaseData.IsNetCore
        };
