...
namespace Clio.Tests
{
    ...
    public class ProcessDesignerRequiresPackageAttributeTests
    {
        ...
        [TestCase(typeof(CreateBusinessProcessOptions), "1.6.6.24")]
        [TestCase(typeof(ModifyBusinessProcessOptions), "1.6.6.24")]
        [Test]
        ...
        [TestCase(typeof(ModifyProcessAsNewVersionOptions), "1.6.6.24")]
            ...
            string expectedVersion)
        {
            ...
            requirement!.Version.Should().Be(expectedVersion,
                because: "the versioning operations first ship in the 1.6.1.0 archive, and the one that carries an "
                    ...
                    + "template members (ENG-95986), to 1.6.6.14 with subProcess.multiInstanceOptions and to "
                    + "1.6.6.24 with sourceColumn / elementParameter.column (ENG-91844) "
