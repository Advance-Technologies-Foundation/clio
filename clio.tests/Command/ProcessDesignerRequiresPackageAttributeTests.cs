            ...
            string expectedVersion)
        {
            ...
            requirement!.Version.Should().Be(expectedVersion,
                because: "the versioning operations first ship in the 1.6.1.0 archive, and the one that carries an "
                    + "operations array followed the operations vocabulary up three times - to 1.6.2.1 with the Send "
                    + "email template members (ENG-95986), to 1.6.6.14 with subProcess.multiInstanceOptions "
                    + "(ENG-99856) and to 1.6.6.25 with sourceColumn / elementParameter.column (ENG-91844). Presence-only "
