...
public class PageToolsTests
{
	...
	public void PageUpdateTool_Description_Should_Contain_Validator_Section_Authoring_Rules() {
		...
		description.Should().Contain("get-request-info `crt.RunBusinessProcessRequest`",
			because: "update-page should route run-process buttons to the request catalog (get-request-info crt.RunBusinessProcessRequest), resolving parameter codes via get-process-signature first");
	}
