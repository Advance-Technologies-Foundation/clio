...
public sealed class AddPackageDependencyToolTests {
	...
	public void AddPackageDependencyArgs_ShouldExposeKebabCaseJsonNames() {
		// Arrange
		string EnvName(string property) => typeof(AddPackageDependencyArgs)
		...
		(string environment, string package, string dependencies) =
			(EnvName(nameof(AddPackageDependencyArgs.EnvironmentName)),
				EnvName(nameof(AddPackageDependencyArgs.PackageName)),
				EnvName(nameof(AddPackageDependencyArgs.Dependencies)));
	...
	public void AddPackageDependency_ShouldResolveCommandAndMapArguments() {
		...
		AddPackageDependencyArgs args = new("dev", "MyApp", [
