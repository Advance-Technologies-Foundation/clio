...
public class ManageWindowsFeaturesCommandTestFixture : BaseClioModuleTests
{
    ...
    public void GetMissedComponents_CorrectWorking_IfAllFeatureExisting()
    {
        ...
        List<WindowsFeature> existingComponents = new()
        {
            new WindowsFeature
            {
                Name = "Feature1", Installed = true
            },
            new WindowsFeature
            {
                Name = "Feature2", Installed = true
            }
        };
        ...
        WindowsFeatureManager windowsFeatureManager = new(wp, new ConsoleProgressbar(), windowsFeatureProvider, logger)
        {
    ...
    public void GetMissedComponents_ShouldInstallMissedComponents()
    {
        ...
        List<WindowsFeature> existingComponents = new()
        {
            new WindowsFeature
            {
                Name = "Feature3", Installed = false
            },
            new WindowsFeature
            {
                Name = "Feature4", Installed = false
            }
        };
