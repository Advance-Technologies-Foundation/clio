.<%themeCssClass%> {
	/* Semantic colors: Background / Base */
	...
	--crt-color-background-disabled: var(--crt-palette-neutral-50);

	/* Semantic colors: Background / Role colors */
	...
	/* Semantic colors: Border / Role colors */
	...
	/* Semantic colors: Text / Role colors */
	...
	/* Semantic colors: Icon / Role colors */
	...
	--crt-overline-text-transform: none;
