...
// environment below the archive clio ships (1.6.6.24 today, 1.6.2.1 when this was written) on this same
...
// Raised to 1.6.6.24 by ENG-91844: `sourceColumn` (mappings, changeData/addData/openEditPage values,
...
// expected". 1.6.6.24 is the archive cut from crt-process-builder c278ac4.
[RequiresPackage(BundledPackages.ProcessBuilderPackageName, "1.6.6.24",
