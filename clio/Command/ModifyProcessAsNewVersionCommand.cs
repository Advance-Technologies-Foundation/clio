...
// environment below the archive clio ships (1.6.6.12 today, 1.6.2.1 when this was written) on this same
...
// Raised to 1.6.6.12 by ENG-99856: `subProcess.multiInstanceOptions`, the dotted per-item path on
...
// package. 1.6.6.12 is the archive cut from crt-process-builder c1d2165.
[RequiresPackage(BundledPackages.ProcessBuilderPackageName, "1.6.6.12",
