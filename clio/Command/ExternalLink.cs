...
public class ExternalLinkOptions : EnvironmentOptions
{
    ...
    [Value(0, Default = "")] public string Content { get; set; }

    public override bool ShowDefaultEnvironment() => false;
}

public class ExternalLinkCommand(IMediator mediator, IValidator<ExternalLinkOptions> validator, ILogger logger)
    : Command<ExternalLinkOptions>
{
    ...
    /// <summary>
    ///     Make sure to call clio register before testing, see reg/clio_context_menu_win.reg Lines 20-24 (protocol
    ///     registration)
