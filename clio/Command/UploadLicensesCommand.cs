...
public class UploadLicensesCommand(IApplicationClient applicationClient, EnvironmentSettings settings)
    : RemoteCommand<UploadLicensesOptions>(applicationClient, settings)
{
