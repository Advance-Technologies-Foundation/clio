...
public class WorkspacePackageTool(
	...
	public CommandExecutionResult AddPackage(
		...
		AddPackageOptions options = new() {
			...
			SchemaNamePrefix = args.SchemaNamePrefix,
...
public record AddPackageArgs(
	...
	[property:JsonPropertyName("schema-name-prefix")]
	[Description("Prefix for schemas generated by as-app. Omit to read SchemaNamePrefix from environment-name; an empty value deliberately generates no prefix")]
