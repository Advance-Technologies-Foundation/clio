...
public sealed class GuidanceGetTool {
	...
	[Description("Returns a named clio MCP guidance article, or lists all available guide names when the requested name is unknown. Known names include clio guides such as app-modeling, page-modification, indicator-widget, esq-filters, and page-schema-handlers plus composable-app skill guides such as atf-repository-dev, feature-toggle, sys-setting, configuration-webservice, and their test guides.")]
	public Task<GuidanceGetResponse> GetGuidance(
		[Description("Parameters: name (required). Use one of the known guidance names returned in availableGuides, for example atf-repository-dev, feature-toggle-tests, sys-setting, configuration-webservice, indicator-widget, esq-filters, page-modification, page-schema-handlers, or existing-app-maintenance.")]
...
public sealed record GuidanceGetArgs(
	...
	[property: Description("Stable guidance name. Use one of the names returned in 'availableGuides' when unknown, for example atf-repository-dev, feature-toggle-tests, sys-setting, configuration-webservice, indicator-widget, esq-filters, page-modification, page-schema-handlers, or existing-app-maintenance.")]
	string? Name = null
) {
	[JsonExtensionData]
