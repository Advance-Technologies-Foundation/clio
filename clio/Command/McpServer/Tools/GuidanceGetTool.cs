...
public sealed class GuidanceGetTool(IGuidanceAccessLedger guidanceAccessLedger) {
	...
	[Description("Returns a named clio MCP guidance article, or lists all available guide names when "
		...
		+ "guides such as atf-repository-dev, feature-toggle, sys-settings, configuration-webservice, "
		+ "and their test guides.")]
	public Task<GuidanceGetResponse> GetGuidance(
		[Description("Parameters: name (required). Use one of the known guidance names returned in availableGuides, for example atf-repository-dev, feature-toggle-tests, sys-settings, configuration-webservice, page-modification, page-schema-handlers, indicator-widget, ui-guidelines, related-list, esq-filters, or existing-app-maintenance.")]
...
public sealed record GuidanceGetArgs(
	...
	[property: Description("Stable guidance name. Use one of the names returned in 'availableGuides' when unknown, for example atf-repository-dev, feature-toggle-tests, sys-settings, configuration-webservice, page-modification, page-schema-handlers, indicator-widget, ui-guidelines, related-list, esq-filters, or existing-app-maintenance.")]
	string? Name = null
) {
	[JsonExtensionData]
