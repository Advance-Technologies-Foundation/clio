...
public sealed class GuidanceGetTool {
	...
	public Task<GuidanceGetResponse> GetGuidance(
		[Description("Parameters: name (required). Use one of the known guidance names returned in availableGuides, for example atf-repository-dev, feature-toggle-tests, sys-setting, configuration-webservice, page-modification, page-schema-handlers, indicator-widget, esq-filters, or existing-app-maintenance.")]
...
public sealed record GuidanceGetArgs(
	...
	[property: Description("Stable guidance name. Use one of the names returned in 'availableGuides' when unknown, for example atf-repository-dev, feature-toggle-tests, sys-setting, configuration-webservice, page-modification, page-schema-handlers, indicator-widget, esq-filters, or existing-app-maintenance.")]
	string? Name = null
) {
	[JsonExtensionData]
