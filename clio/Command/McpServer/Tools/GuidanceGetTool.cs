...
public sealed class GuidanceGetTool {
	...
	[Description("Returns canonical clio MCP guidance text by stable guide name so clients do not need to fetch docs:// resources directly. Known names: app-modeling, data-bindings, existing-app-maintenance, dataforge-orchestration, page-schema-validators.")]
	public GuidanceGetResponse GetGuidance(
		[Description("Parameters: name (required). Use one of the known guidance names such as data-bindings, page-schema-validators, or existing-app-maintenance.")]
		[Required]
...
public sealed record GuidanceGetArgs(
	...
	[property: Description("Stable guidance name, for example data-bindings, page-schema-validators, or existing-app-maintenance.")]
	[property: Required]
	string Name
);
