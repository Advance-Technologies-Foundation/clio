...
public sealed record GuidanceGetArgs(
	...
	[property: Description("Stable guidance name. Use one of the names returned in 'availableGuides' when unknown, for example page-schema-handlers, page-schema-creatio-devkit-common, page-schema-validators, or existing-app-maintenance.")]
	string? Name = null
) {
	[JsonExtensionData]
