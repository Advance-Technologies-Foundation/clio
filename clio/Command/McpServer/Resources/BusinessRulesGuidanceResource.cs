...
public sealed class BusinessRulesGuidanceResource {
	...
	internal static readonly TextResourceContents Guide = new() {
		...
		Text = """
		       ...
		       Workflow
		       1. Call `get-tool-contract` for the business-rule tool you will call (create, update, or delete; entity or page). When updating or deleting existing rules, first call `read-entity-business-rules` / `read-page-business-rules` to obtain exact rule names and block uIds.
