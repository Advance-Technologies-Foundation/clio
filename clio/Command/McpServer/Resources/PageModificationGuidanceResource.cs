...
public sealed class PageModificationGuidanceResource {
	...
	internal static readonly TextResourceContents Guide = new() {
		...
		Text = """
		       ...
		       | working with analytics pages / a dashboard with metric indicators or charts | `analytics-widgets` | Index guide; routes to dashboards (layout), indicator-widget (payload), placement-contexts (non-dashboard surfaces) |
