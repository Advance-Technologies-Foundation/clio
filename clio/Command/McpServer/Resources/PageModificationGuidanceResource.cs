...
/// <summary>
/// Provides canonical AI-facing guidance for Freedom UI page modification through clio MCP. This is the
/// ENTRY guide of the page-modification family: it owns the mandatory pre-edit GATE checklist and the
/// canonical flow, then routes the detailed mechanics to four focused sub-guides
/// (<c>page-modification-overview</c>, <c>-field-contract</c>, <c>-containers</c>, <c>-components</c>),
...
public sealed class PageModificationGuidanceResource {
	...
	internal static readonly TextResourceContents Guide = new() {
		...
		Text = """
		       ...
		       | inserting a data-bound field control: viewModelConfigDiff binding, label/resource rule, canonical payload, diagnostics | `page-modification-field-contract` |
		       | choosing where a component goes: bundle.json shape, jq recipes, picking a valid `parentName` | `page-modification-containers` |
		       | composing a viewConfigDiff insert: button + click handler, operation/type/name rules, reading get-component-info | `page-modification-components` |
