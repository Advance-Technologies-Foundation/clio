...
public sealed class CoreRulesGuidanceResource {
	...
	internal static readonly TextResourceContents Guide = new() {
		...
		Text = """
		       ...
		       - Long-running tools (create-app, create-app-section, update-app-section, get-app-info, sync-schemas) stream progress; a progress notification is NOT a timeout. Do not cancel or retry; read state with get-app-info / list-app-sections first. These progress-streaming reads are exempt from the read-response deadline below — await their completion.
