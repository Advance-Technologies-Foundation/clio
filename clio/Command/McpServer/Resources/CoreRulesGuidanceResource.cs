...
public sealed class CoreRulesGuidanceResource {
	...
	internal static readonly TextResourceContents Guide = new() {
		...
		Text = """
		       ...
		       - uninstall-creatio may complete with a WarningMessage, a warning stage, and a success-with-warnings terminal when Windows cannot remove a locked IIS application-pool profile (exit code 0 / IsError=false); show the warning and manual-cleanup detail, but do not retry the destructive command.
