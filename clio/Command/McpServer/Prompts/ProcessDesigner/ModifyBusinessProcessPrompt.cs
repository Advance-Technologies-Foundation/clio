	...
	public static string PromptByProcess(
		...
		$"""
		 ...
		 - `addParameter` — `parameter` (a process-level parameter: `name`, `type` e.g. `Text`/`Integer`/`Guid`,
		   optional `direction` In/Out/Variable/Internal, optional `caption`, optional `value` (a constant default); or `referenceSchema` = an object name
