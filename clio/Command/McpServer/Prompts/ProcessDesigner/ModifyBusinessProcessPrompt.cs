...
public static class ModifyBusinessProcessPrompt {
	...
	public static string PromptByProcess(
		...
		$"""
		 ...
		 `[#SysVariable.CurrentUserAccount#]`, `[#SysVariable.CurrentUser#]`. That is the whole set: a name outside
		 it is stored unchecked and then breaks the process compile, and system variables cannot be looked up
		 (they are neither an entity nor an entity schema).
		 """;
}
