...
public static class PagePrompt {
	...
	public static string GetPage(
		...
		$"""
		 ...
		 If the page-body task designs or lays out the page UI/UX (choosing a component for a concept, placing or ordering fields, grid columns/colSpan, container nesting, grouping into tabs/groups, captions/tooltips/placeholders), call `{GuidanceGetTool.ToolName}` with `name` set to `ui-guidelines` before composing the body, and author from it, not from memory; it routes to `ui-page-layout`, `ui-accessibility`, and `ui-review-checklists`.
