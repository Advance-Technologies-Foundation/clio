...
public static class PagePrompt {
	...
	public static string GetPage(
		...
		$"""
		 ...
		 For any page-body modification, call `{GuidanceGetTool.ToolName}` with `name` set to `page-modification` before editing the body file `get-page` writes at `files.bodyFile`; follow its pre-edit checklist to route localizable strings, converters, handlers, validators, SDK calls, and business-rule requirements to specialized guides.
