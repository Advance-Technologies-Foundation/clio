...
public interface IEntityBusinessRuleService {
	...
	/// <summary>
	/// Reads every business rule persisted for the entity schema (full package hierarchy).
	/// </summary>
	/// <param name="request">Read input.</param>
	/// <returns>One read model per parent rule, in persisted order.</returns>
	IReadOnlyList<BusinessRuleReadModel> Read(EntityBusinessRulesReadRequest request);

	/// <summary>
	/// Updates rules matched by <c>name</c> on the same package and entity schema in a single
	/// add-on round-trip. Matched rules are fully replaced with stable identity preserved
	...
	/// </summary>
	/// <param name="request">Batch business-rule update input; every rule requires <c>name</c>.</param>
	/// <returns>Per-rule outcomes, one entry per input rule, in input order.</returns>
	IReadOnlyList<BusinessRuleBatchItemResult> Update(EntityBusinessRulesBatchRequest request);

	/// <summary>
	/// Deletes rules by name on the same package and entity schema in a single add-on round-trip,
	/// cascading to autogenerated apply-filter child rules. Unknown names are isolated per-item
	/// failures.
	/// </summary>
...
/// <summary>
/// Describes the package and entity schema whose business rules are read.
/// </summary>
...
/// <summary>
/// Describes the package, entity schema, and rule names to delete in one batch.
/// </summary>
...
internal sealed class EntityBusinessRuleService(
	...
	public IReadOnlyList<BusinessRuleReadModel> Read(EntityBusinessRulesReadRequest request) {
		ArgumentNullException.ThrowIfNull(request);
