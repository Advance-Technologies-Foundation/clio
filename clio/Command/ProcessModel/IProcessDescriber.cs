...
public sealed class DescribedFlow {
	...
	/// <para>Reported from <c>CrtProcessBuilder</c> 1.6.2.22. These are the same captions the write surface
	...
	/// so the two dialects are distinguishable from the read alone. ABSENT on a package older than 1.6.2.22,
