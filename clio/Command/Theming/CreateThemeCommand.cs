...
namespace Clio.Command.Theming
{
	...
	public class CreateThemeCommand : RemoteCommand<CreateThemeOptions>
	{
		...
		/// <summary>
		/// The effective theme id from the most recent successful execution (the supplied <c>--id</c> or the
		/// auto-generated UUID). <c>null</c> until the command has created a theme.
		/// </summary>
