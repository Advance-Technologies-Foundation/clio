...
[Verb("execute-sql-script", Aliases = new[]
{
    "sql"
}, HelpText = "Execute script on web application")]
...
public class SqlScriptCommand : RemoteCommand<ExecuteSqlScriptOptions>
{
    ...
    private static void SaveDataTableToXlsx(DataTable dataTable, string filePath)
    {
                   ...
                   SpreadsheetDocumentType.Workbook))
        {
            ...
            Sheet sheet = new()
            {
                Id = spreadsheetDocument.WorkbookPart.GetIdOfPart(worksheetPart), SheetId = sheetId, Name = sheetName
            };
            sheets.Append(sheet);
