...
public class EnvironmentOptions
{
    ...
    public void CopyFromEnvironmentSettings(EnvironmentOptions source)
    {
        ...
        DbPassword = source.DbPassword;
        BackUpFilePath = source.BackUpFilePath;
        DbWorknigFolder = source.DbWorknigFolder;
        DbName = source.DbName;
        Force = source.Force;
        CallbackProcess = source.CallbackProcess;
    }
...
internal class ConvertOptions
{
    ...
    public static IEnumerable<Example> Examples =>
        new List<Example>
        {
            new("Convert existing packages",
                new ConvertOptions
                {
                    Path = "C:\\Pkg\\", Name = "MyApp,MyIntegration"
                }),
    ...
    [Option('c', "ConvertSourceCode", Required = false, HelpText = "Convert source code schema to files",
        Default = false)]
...
[Verb("install-gate", Aliases = new[]
{
    "update-gate", "gate", "installgate"
}, HelpText = "Install clio api gateway to application")]
internal class InstallGateOptions : EnvironmentNameOptions
{ }

[Verb("add-item", Aliases = new[]
{
    "create"
}, HelpText = "Create item in project")]
