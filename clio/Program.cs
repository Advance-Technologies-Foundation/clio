...
internal class Program {
	...
	private static readonly Type[] CommandOption = [
		...
		typeof(GetClassicSchemaOptions),
		typeof(ListSchemaLayersOptions),
		typeof(ResolveMigrationUnitOptions),
	...
	public static Func<object, int> ExecuteCommandWithOption = instance => {
		...
		return instance switch {
			...
			GetClassicSchemaOptions opts => Resolve<GetClassicSchemaCommand>(opts).Execute(opts),
			ListSchemaLayersOptions opts => Resolve<ListSchemaLayersCommand>(opts).Execute(opts),
			ResolveMigrationUnitOptions opts => Resolve<ResolveMigrationUnitCommand>(opts).Execute(opts),
