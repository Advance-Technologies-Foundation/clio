...
internal class Program {
	...
	private static readonly Type[] CommandOption = [
		...
		typeof(GetClassicMigrationBundleOptions),
		typeof(GetClassicSchemaByUidOptions),
		typeof(ListSchemaHierarchyOptions),
	...
	public static Func<object, int> ExecuteCommandWithOption = instance => {
		...
		return instance switch {
			...
			GetClassicMigrationBundleOptions opts => Resolve<GetClassicMigrationBundleCommand>(opts).Execute(opts),
			GetClassicSchemaByUidOptions opts => Resolve<GetClassicSchemaByUidCommand>(opts).Execute(opts),
			ListSchemaHierarchyOptions opts => Resolve<ListSchemaHierarchyCommand>(opts).Execute(opts),
