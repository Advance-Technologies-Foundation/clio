...
internal class Program {
	...
	private static readonly Type[] CommandOption = [
		...
		typeof(Command.ObjectRights.SetObjectRightsOptions),
		typeof(Command.ObjectRights.GetObjectRightsOptions),
	...
	public static Func<object, int> ExecuteCommandWithOption = instance => {
		...
		return instance switch {
			...
			Command.ObjectRights.SetObjectRightsOptions opts => Resolve<Command.ObjectRights.SetObjectRightsCommand>(opts).Execute(opts),
			Command.ObjectRights.GetObjectRightsOptions opts => Resolve<Command.ObjectRights.GetObjectRightsCommand>(opts).Execute(opts),
