...
internal class Program
{
        ...
        return instance switch
               {
                   ...
                   CustomizeDataProtectionCommandOptions opts => Resolve<CustomizeDataProtectionCommand>(opts)
                       .Execute(opts),
        ...
        params object[] additionalConstructorArgs)
    {
        ...
        }.Concat(additionalConstructorArgs).ToArray();
    ...
    private static int SetDeveloperMode(DeveloperModeOptions opts)
    {
        try
        {
            ...
            {
                Code = "Maintainer", Value = CreatioEnvironment.Settings.Maintainer
            };
