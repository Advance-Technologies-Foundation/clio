...
public class BindingsModule {
	...
	public IServiceProvider Register(EnvironmentSettings settings = null,
		...
		services.AddTransient<AddItemModelTool>();
		services.AddTransient<ClearRedisTool>();
		services.AddTransient<CompileCreatioTool>();
		services.AddTransient<CreateDataBindingDbTool>();
		services.AddTransient<CreateDataBindingTool>();
		services.AddTransient<CreateTestProjectTool>();
		services.AddTransient<CreateUserTaskTool>();
		services.AddTransient<CreateWorkspaceTool>();
		services.AddTransient<DeleteSkillTool>();
		services.AddTransient<DownloadConfigurationTool>();
		services.AddTransient<FsmModeTool>();
		services.AddTransient<GenerateProcessModelTool>();
		services.AddTransient<GenerateSourceCodeTool>();
		services.AddTransient<InstallApplicationTool>();
		services.AddTransient<InstallSkillsTool>();
		services.AddTransient<InstallerCommandTool>();
		services.AddTransient<LinkFromRepositoryTool>();
		services.AddTransient<LoadPackagesTool>();
		services.AddTransient<ModifyUserTaskParametersTool>();
		services.AddTransient<PushWorkspaceTool>();
		services.AddTransient<RegWebAppTool>();
		services.AddTransient<RestartTool>();
		services.AddTransient<RestoreDbTool>();
		services.AddTransient<RestoreWorkspaceTool>();
		services.AddTransient<SchemaSyncTool>();
		services.AddTransient<StartTool>();
		services.AddTransient<StopTool>();
		services.AddTransient<SysSettingUpsertTool>();
		services.AddTransient<UninstallCreatioTool>();
		services.AddTransient<UpdateSkillTool>();
		services.AddTransient<WorkspacePackageTool>();
