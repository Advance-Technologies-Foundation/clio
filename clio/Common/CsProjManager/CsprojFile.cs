    ...
    public IEnumerable<Reference> GetPackageReferences()
    {
        ...
        return rootNode.ChildNodes.OfType<XmlElement>()
                       ...
                       .Select(i =>
                       {
                           ...
                           string version = i.ChildNodes.OfType<XmlElement>().FirstOrDefault(x => x.Name == "Version")
                                             ?.InnerText;
                           string hintPath = i.ChildNodes.OfType<XmlElement>()
                           ...
                           string @private = i.ChildNodes.OfType<XmlElement>().FirstOrDefault(x => x.Name == "Private")
                                              ?.InnerText;
