...
public class FileSystem : IFileSystem
{
    ...
    public void CopyFile(string from, string to, bool overwrite) => _msFileSystem.File.Copy(from, to, overwrite);
    ...
    public void DeleteDirectory(string directoryPath) => DeleteDirectory(directoryPath, false);
