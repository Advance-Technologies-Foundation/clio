...
namespace cliogate.Files.cs
{
	...
	public class CreatioApiGateway : BaseService
	{
		...
		private Stream GetCompressedFolder(string rootRelativePath, string fileName, IEnumerable<string> ignoreDirectoriesName = null) {
			string baseDirectory = AppDomain.CurrentDomain.BaseDirectory;
			string rootDirectoryPath = Path.Combine(baseDirectory, rootRelativePath);
			if (!Directory.Exists(rootDirectoryPath)) {
				return null;
			}
			MemoryStream compressedAutogeneratedFolder = CompressionUtilities.GetCompressedFolder(rootDirectoryPath, ignoreDirectoriesName);
