define("ParallelDev_FormPage", /**SCHEMA_DEPS*/[]/**SCHEMA_DEPS*/, function/**SCHEMA_ARGS*/()/**SCHEMA_ARGS*/ {
	return {
		viewConfigDiff: /**SCHEMA_VIEW_CONFIG_DIFF*/[
			...
			{
				"operation": "insert",
				"name": "EmailInput_jr3016m",
				"values": {
					"type": "crt.EmailInput",
					"label": "$Resources.Strings.PDS_Columnemail1_l2a4qgo",
					"control": "$PDS_Columnemail1_l2a4qgo",
					"labelPosition": "auto",
					"placeholder": "",
					"tooltip": "",
					"needHandleSave": false
			...
			},
			{
				...
				"values": {
					...
					"type": "crt.IndicatorWidget",
					"config": {
						"title": "#ResourceString(IndicatorWidget_1ct2hly_title)#",
						"theme": "without-fill",
						"layout": {
							"color": "green"
						},
						...
						"data": {
							...
							"providing": {
								"attribute": "IndicatorWidget_1ct2hly_Data",
								"schemaName": "ParallelDev",
								"filters": null,
								"aggregation": {
									"column": {
		...
		viewModelConfigDiff: /**SCHEMA_VIEW_MODEL_CONFIG_DIFF*/[
			{
				...
				"values": {
					...
					"PDS_Columnemail1_l2a4qgo": {
						"modelConfig": {
							"path": "PDS.Columnemail1"
						}
					}
				}
			},
