...
internal sealed class SampleClioAdapter : IClioAdapter {
	...
	private static readonly ClioEnvironment[] Environments = {
		...
		new("rss", "https://k-krylov-nb.tscrm.com:40055", false),
		new("d1", "https://k-krylov-nb.tscrm.com:40065", true),
		new("bndl", "https://k-krylov-nb.tscrm.com:40075", true),
		new("bndl75", "https://k-krylov-nb.tscrm.com:40075", false),
		new("calc", "https://k-krylov-nb.tscrm.com:40000", true),
		...
		new("ira", "https://k-krylov-nb.tscrm.com:40090", false),
		...
		new("a1", "https://k-krylov-nb.tscrm.com:41001", true),
		new("a2", "https://k-krylov-nb.tscrm.com:41002", true),
		new("a3", "https://k-krylov-nb.tscrm.com:41003", true),
		new("a4", "https://k-krylov-nb.tscrm.com:41004", true),
		new("a5", "https://k-krylov-nb.tscrm.com:41005", false)
	};
