...
public enum ActionKind {
	/// <summary>Runs a clio CLI verb as a child process. See <see cref="LauncherAction.ClioCommand"/>.</summary>
	ClioCommand,

	/// <summary>Opens a URL in the default browser. See <see cref="LauncherAction.OpenUrl"/>.</summary>
	OpenUrl,

	/// <summary>Opens a file-system path with the OS shell. See <see cref="LauncherAction.OpenPath"/>.</summary>
	OpenPath,
...
public sealed record ActionCatalog {
	...
	public IReadOnlyList<LauncherAction> Actions { get; init; } = new List<LauncherAction>();
}
