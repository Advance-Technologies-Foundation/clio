...
macOS 27.0.0 (arm64), .NET 10.0.12. **28/28 passed, exit 0.** The contract derived from these cases is in
...
**27/27 passed, exit 0**, from a clean clone of this branch at `4c486e6747ce` — nothing modified.
