...
Acceptance:
- [ ] `clio.mcp.e2e` covers create, modify and as-new-version with an unknown key, asserting refusal or
      warning by the stand's installed vs bundled version. TC-I-01..TC-I-03.
- [ ] Guidance (clio-knowledge, draft PR with a `libraryVersion` bump) states the refusal; tool descriptions
      do not grow (payload-budget ceiling).
- [ ] `docs/knowledge/` record of the measured silent drop and of why the key set lives in clio.
