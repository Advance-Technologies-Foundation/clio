...
namespace DataBindingPkgApp {

	/// <summary>
	/// This is a class that provides access to the application services.
	/// This is the MAIN entry point into the DataBindingPkgApp package.
	/// </summary>
	public sealed class DataBindingPkgApp {

		#region Fields: Private

		private static Lazy<DataBindingPkgApp> _instance = new Lazy<DataBindingPkgApp>(() => new DataBindingPkgApp());
		...
		public static DataBindingPkgApp Instance => _instance.Value;
		...
		/// </summary>
		/// <returns></returns>
		internal DataBindingPkgApp Reset(){
			_serviceProvider.Value?.Dispose();
			_instance = null;
			_instance = new Lazy<DataBindingPkgApp>(() => new DataBindingPkgApp());
