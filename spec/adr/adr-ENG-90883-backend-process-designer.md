...
This ADR is **retrospective**: it records decisions already made ([Research §3](https://creatio.atlassian.net/wiki/spaces/TER/pages/4702928908) — approach + placement, v22) and implemented, to give the clio repo a single in-tree architectural reference for the backend process-designer feature. The authoritative, continuously-updated state lives on the Jira ticket and the Confluence pages linked above.
